...
public class UpdateProductActivity extends AppCompatActivity implements UploadCallBack {
    ...
    HashMap<String, String> menu_data_for_ger_key = new HashMap<>();
    HashMap<String, String> menu_data_for_ger_value = new HashMap<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_menu.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(MaterialSpinner view, int position, long id, Object item) {
                selected_category = menu_data_for_ger_key.get(menu_data.get(position));
            }
        });
    ...
    private void setProductInfo() {
        if (Common.currentDrink != null)
        {
            ...
            spinner_menu.setSelectedIndex(menu_data.indexOf(menu_data_for_ger_value.get(Common.currentCategory.getID())));
        }
    }
    ...
    private void setSpinnerMenu() {
        ...
        for (Category category : Common.menuList) {
            menu_data_for_ger_key.put(category.getName(), category.getID());
            menu_data_for_ger_value.put(category.getID(), category.getName());
